...
from nisync import _library_singleton, _visatype, enums, errors
from nisync._session_attributes import SessionAttributes
from nisync._time_references import (
    EtherCATTimeReference,
    GPSTimeReference,
    IEEE1588TimeReference,
    IEEE8021ASTimeReference,
    IRIGBTimeReference,
    PPSTimeReference,
)
...
class _SessionBase(SessionAttributes):
